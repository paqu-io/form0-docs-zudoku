...
Use Expo Go for supported native modules; use a
[development build](https://docs.expo.dev/develop/development-builds/introduction/) when the app
needs custom native code.
