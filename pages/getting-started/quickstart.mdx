...
1. Install the CLI:
   ...
   **form0 is not public yet.** The npm package is private, so you'll need to:

   - Request access by emailing [hello@paqu.io](mailto:hello@paqu.io)
   - Once approved, log in to npm in your terminal:
      ```bash
      npm login
      ```
